...
const slides = [
  {
    ...
    description:
      "Discover special discounts and benefits from our verified KADIN partners to support your business operations.",
  ...
  },
  {
    ...
    description:
      "Enhance your team's digital capabilities with our upcoming masterclass on AI integration and data analytics.",
...
const PromoCarousel: React.FC<PromoCarouselProps> = ({ setCurrentPage }) => {
  ...
  return (
    <div className="h-[400px] w-full m-auto relative group">
      ...
      {/* Left Arrow */}
      <div
        className="hidden group-hover:block absolute top-1/2 -translate-y-1/2 left-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer z-10"
